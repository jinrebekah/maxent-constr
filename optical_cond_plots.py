...
def calc_rho_df(pickle_folder, nfluxes, n, U, betas, mus=[None], use_xy=True, calc_xx_proxy=False, calc_xy_proxy=False, save_csv=False):
...
######################## plots vs. B
def _setup_plot(df, betas, x_label, y_label, Nx=None, Ny=None, tp=None, color_dict=None, ax=None, figsize=None):
...
def plot_dc_sig_B(df, nfluxes, n, U, betas, mode, Nx=None, Ny=None, tp=None, ylim=None, xlim=None, ax=None, show_legend=True, color_dict=None, style={}):
    ...
    for k, beta in enumerate(betas):
        ...
        ax.errorbar(Bs_plot, sigs, yerr=sig_errs, label=rf'$\beta$={beta}', markersize=2, color = color_dict[beta], elinewidth=1, capsize=0.8, **style)
